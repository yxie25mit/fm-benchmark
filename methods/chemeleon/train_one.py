...
def compute_val_metric(out, scratch_root, dataset, protocol, seed, targets, task_type,
    ...
    try:
        ...
        np.save(out / "ids_val.npy", smiles_global_ids(common, val_idx, full, val_lab.shape[0], "chemeleon"))
    except Exception:
        pass
...
def main():
    ...
    np.save(out / "ids_test.npy", smiles_global_ids(common, test_idx, full, pred_mat.shape[0], "chemeleon"))
